...
const BotonPlus = ({text,color}) => {
    ...
    return (
        ...
        <button className="btnPlus">
            <span class="circle1"style={{ backgroundColor: color }}></span>
            <span class="circle2"style={{ backgroundColor: color }}></span>
            <span class="circle3"style={{ backgroundColor: color }}></span>
