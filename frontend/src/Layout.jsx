...
export default function GridTemplateRows() {
  return (
    <div className="Layout_contenedor" style={{background: '#18191a' }}>
      <Box id="box" sx={{ display: 'grid',height: '100vh', gridTemplateRows: 'repeat(6, 4rem)' }}>
        ...
        <Link id="Link" className="Link_Eventos">
